...
INFO "  sail-review-packet (future summary-only Sail review packet)"
INFO "  sail-evidence-manifest (future summary-only Sail evidence manifest)"
INFO "  sail-evidence-detail (future descriptor-only Sail evidence detail shape)"
INFO "  sail-model-readiness (future descriptor-only Sail model-readiness gate)"
INFO "  sail-implementation-gap-matrix (future descriptor-only Sail gap matrix)"
INFO "  sail-source-intake-boundary (future descriptor-only Sail source intake boundary)"
INFO "  sail-source-intake-approval (future descriptor-only Sail source intake approval gate)"
INFO "  sail-source-intake-result (future descriptor-only Sail source intake result boundary)"
INFO "  sail-source-intake-handoff (future descriptor-only Sail source intake handoff summary)"
INFO "  sail-source-intake-status-summary (future descriptor-only Sail source intake status summary)"
...
INFO "  hybrid-evidence-manifest (future summary-only hybrid evidence manifest)"
INFO "  hybrid-evidence-detail (future descriptor-only hybrid evidence detail shape)"
INFO "  hybrid-implementation-readiness (future descriptor-only hybrid implementation-readiness gate)"
INFO "  hybrid-implementation-gap-matrix (future descriptor-only hybrid gap matrix)"
INFO "  hybrid-source-intake-boundary (future descriptor-only hybrid source intake boundary)"
INFO "  hybrid-source-intake-approval (future descriptor-only hybrid source intake approval gate)"
INFO "  hybrid-source-intake-result (future descriptor-only hybrid source intake result boundary)"
INFO "  hybrid-source-intake-handoff (future descriptor-only hybrid source intake handoff summary)"
INFO "  hybrid-source-intake-status-summary (future descriptor-only hybrid source intake status summary)"
...
INFO "  mcp-sample-status-summary (future descriptor-only sample status summary)"
...
INFO "  plugin-sample-status-summary (future descriptor-only sample status summary)"
...
check_file "$REPO_ROOT/docs/examples/sail-review-packet.example.json"
check_file "$REPO_ROOT/docs/examples/sail-evidence-manifest.example.json"
check_file "$REPO_ROOT/docs/examples/sail-evidence-detail.example.json"
check_file "$REPO_ROOT/docs/examples/sail-model-readiness.example.json"
check_file "$REPO_ROOT/docs/examples/sail-implementation-gap-matrix.example.json"
check_file "$REPO_ROOT/docs/examples/sail-source-intake-boundary.example.json"
check_file "$REPO_ROOT/docs/examples/sail-source-intake-approval.example.json"
check_file "$REPO_ROOT/docs/examples/sail-source-intake-result.example.json"
check_file "$REPO_ROOT/docs/examples/sail-source-intake-handoff.example.json"
check_file "$REPO_ROOT/docs/examples/sail-source-intake-status-summary.example.json"
...
check_file "$REPO_ROOT/docs/examples/hybrid-evidence-manifest.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-evidence-detail.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-implementation-readiness.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-implementation-gap-matrix.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-source-intake-boundary.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-source-intake-approval.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-source-intake-result.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-source-intake-handoff.example.json"
check_file "$REPO_ROOT/docs/examples/hybrid-source-intake-status-summary.example.json"
...
check_file "$REPO_ROOT/docs/examples/mcp-sample-status-summary.example.json"
...
check_file "$REPO_ROOT/docs/examples/plugin-sample-status-summary.example.json"
