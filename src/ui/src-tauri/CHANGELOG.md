...
All notable changes to `pccx-ide` will be documented in this file.
...
- Tauri shell (desktop IDE). Renamed from the scaffold `srcui`; folded into the parent workspace so `cargo check --workspace` covers it.
