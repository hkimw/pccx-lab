...
All notable changes to `pccx-authoring` will be documented in this file.
...
- ISA + driver-API TOML compilers. `IsaCompiler` + `ApiCompiler` traits + `CompilerArtefact` struct enable Phase 5D Model-to-ISA-API swap-in backends.
