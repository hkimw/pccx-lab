...
All notable changes to `pccx-core` will be documented in this file.
...
- .pccx format parser + trace + core analytics (roofline, bottleneck, coverage, live_window, step_snapshot). Foundation crate; downstream members depend on it.
