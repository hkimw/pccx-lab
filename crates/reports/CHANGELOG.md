...
All notable changes to `pccx-reports` will be documented in this file.
...
- Markdown report generator plus the `pccx_cli` CLI. `ReportFormat` trait + `MarkdownFormat` impl land as the first pluggable render path.
